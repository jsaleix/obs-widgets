...
export default function Footer() {
    return (
        <footer className="border-t-2 border-gray-500 footer footer-center p-10 bg-black text-base-content rounded">
            <nav>
                <div className="grid grid-flow-col gap-4">
                    ...
                    <a href={SOCIAL_LINKS.twitch} target="_blank">
                        ...
                        >
                            <path
                                d="M8.64005 3.93H10.0701V8.21H8.64005M12.5701 3.93H14.0001V8.21H12.5701M4.00005 0L0.430054 3.57V16.43H4.71005V20L8.29005 16.43H11.1401L17.5701 10V0M16.1401 9.29L13.2901 12.14H10.4301L7.93005 14.64V12.14H4.71005V1.43H16.1401V9.29Z"
                                fill="black"
                                className="fill-current"
                            />
                        </svg>
            ...
            <aside>
                <p>
                    Copyright © 2024 - All right reserved I guess
                </p>
            </aside>
        </footer>
    );
